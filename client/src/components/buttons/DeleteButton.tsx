...
export default function DeleteButton<TArgs, TError = Error>({
    ...
    return (
        <button
            className="w-full text-gray-900 bg-red-500 hover:bg-red-600 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 max-w-sm text-center cursor-pointer disabled:opacity-50"
            disabled={isDeleting}
